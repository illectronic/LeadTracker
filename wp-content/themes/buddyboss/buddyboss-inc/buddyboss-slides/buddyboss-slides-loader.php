...
function buddyboss_slides_assets()
{
    if ( !is_admin() ) { // no loading in the dashboard
        ...
        wp_enqueue_style( 'buddyboss-slides-main', get_template_directory_uri() . '/buddyboss-inc/buddyboss-slides/css/buddyboss-slides.css', array( 'fontawesome', 'googlefonts' ), '3.1.2', 'all' );
