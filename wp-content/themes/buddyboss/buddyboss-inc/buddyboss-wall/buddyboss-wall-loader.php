...
if( !class_exists('BuddyBoss_Wall') ) {
	class BuddyBoss_Wall extends BP_Component {
		...
		function buddyboss_wall_assets()
		{
			...
			wp_enqueue_script( 'buddyboss-wall', get_template_directory_uri() . '/buddyboss-inc/buddyboss-wall/js/buddyboss-wall.js', array( 'jquery', 'buddyboss-wall-tooltip' ), '3.1.4', true );
...
function buddyboss_wall_prepare_user_likes( $activities_template )
{
	...
	{
		$sql  = "SELECT user_id,meta_value FROM {$wpdb->prefix}usermeta
