	...
	class BuddyBoss_Pics extends BP_Component {
		...
		*/
		...
		function buddyboss_pics_assets()
		{
			...
			wp_enqueue_style( 'buddyboss-pics-main', get_template_directory_uri() . '/buddyboss-inc/buddyboss-pics/css/buddyboss-pics.css', array( 'fontawesome', 'googlefonts' ), '3.1.4', 'all' );
