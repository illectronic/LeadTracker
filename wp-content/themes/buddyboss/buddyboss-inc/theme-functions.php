...
function buddyboss_scripts_styles()
{
	...
	if ( !is_admin() ) {
		...
		wp_enqueue_script( 'buddyboss-mobile-main', get_template_directory_uri() . '/js/mobile-main.js', array('jquery'), '3.1.4', true );
	}
	...
	if ( $buddyboss->buddypress_active && !is_admin() )
	{
		...
		wp_enqueue_script( 'buddyboss-buddypress-js', get_template_directory_uri().'/js/buddypress.js', array( 'jquery' ), '3.1.4' );
	}
	...
	wp_localize_script( 'buddyboss-main', 'BuddyBossOptions', $buddyboss_params );
	...
	if ( !is_admin() ) {
		...
		wp_enqueue_style( 'buddyboss-wp-frontend', get_template_directory_uri().'/css/wordpress.css', array( 'fontawesome', 'googlefonts' ), '3.1.5', 'all' );
	}
	...
	*/
	if ( $buddyboss->buddypress_active && !is_admin() )
	{
		...
		wp_enqueue_style( 'buddyboss-bp-frontend', get_template_directory_uri().'/css/buddypress.css', array( 'fontawesome', 'googlefonts' ), '3.1.5', 'all' );
	}
	...
	*/
	...
	if ( !is_admin() ) {
		wp_enqueue_style( 'buddyboss-wp-plugins', get_template_directory_uri().'/css/plugins.css', array( 'fontawesome', 'googlefonts' ), '3.1.5', 'all' );
	}
	...
	if ( !is_admin() ) {
		...
		wp_enqueue_style( 'buddyboss-wp-adminbar-mobile', get_template_directory_uri().'/css/adminbar-mobile.css', array( 'fontawesome', 'googlefonts' ), '3.1.2', 'all' );
		// Activate our own Fixed or Floating (defaults to Fixed) adminbar stylesheet. Load DashIcons and GoogleFonts first.
		wp_enqueue_style( 'buddyboss-wp-adminbar-desktop-'.esc_attr( get_theme_mod( 'boss_adminbar_layout', 'fixed' ) ), get_template_directory_uri().'/css/adminbar-desktop-'.esc_attr( get_theme_mod( 'boss_adminbar_layout', 'fixed' ) ).'.css', array( 'dashicons', 'googlefonts' ), '3.1.6', 'all' );
	}
